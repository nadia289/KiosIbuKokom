...
<body>
    ...
    <section class="products">
        ...
        <h3 class="heading">Daftar Suka</h3>
   ...
   ?>
            <form action="" method="post" class="box">
                ...
                <input type="submit" value="hapus item" onclick="return confirm('hapus ini dari daftar keinginan?');"
   ...
   ?>
        ...
        <div class="wishlist-total">
            <p>total belanjaan: <span>Rp. <?= $grand_total; ?></span></p>
            ...
            <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>"
                onclick="return confirm('hapus semua dari wishlist?');">hapus semua item</a>
        </div>
